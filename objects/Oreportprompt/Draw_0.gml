...
draw_text(540,1100,string("exp : " + string(global.some_data.experience)+ " / " + string(global.some_data.maxexperience)))
		var x1 = 250;
		var x2 = 800;
		var y1= 1200;
		var y2= 1300;
...
if global.some_data.experience == 0 && room == Rvictory
{
	...
	draw_text(540,1400, "LEVEL UP")
	draw_set_color(c_red)
	draw_text(540,1500,"New level :" + string(global.some_data.level))
}
